...
async function initDB(pool) {
  ...
  try {
    ...
    await runQuery("AppSettings - SkipSummary", "IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[AppSettings]') AND name = 'SkipSummary') ALTER TABLE [dbo].[AppSettings] ADD SkipSummary BIT NOT NULL DEFAULT 0");
